...
void CXForciblyMoveToApplicationsFolderConkyX(void) {
    ...
    // Path of the bundle
    NSString *bundlePath = [[NSBundle mainBundle] pathForResource:@"ConkyX" ofType:@"app"];
...
//    Relaunch(destinationPath);
//
//  We must not Relaunch, because this is a custom function, stolen from LetsMove
//  to do the authentication stuff and help us copy ConkyX.app from Resources to /Applications
//
